...
@EnableSwagger2
@EnableWebMvc
@ComponentScan("com.tng.portal.sms.server.controller,com.tng.portal.sms.server.remote.controller")
public class SwaggerConfig {
    ...
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
//                .apis(RequestHandlerSelectors.basePackage("com.tng.portal.sms.server.controller"))
