...
public class HikariCPConfig {
    private final Logger logger = LoggerFactory.getLogger(getClass());//sonarmodify 
    ...
    @Bean
    public DataSource dataSource() {//sonarmodify 
        ...
        try {
            ...
            hds.setPassword(env.getRequiredProperty("spring.datasource.password"));//sonarmodify
            ...
            logger.error(e.getMessage(), e);//sonarmodify
        }
        return hds;
    }
