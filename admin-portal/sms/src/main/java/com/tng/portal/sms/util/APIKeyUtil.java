...
public class APIKeyUtil {
    ...
    private final SimpleDateFormat SDF_YYYYMMDD_HHMMSS = new SimpleDateFormat(DateCode.dateFormatSs);
    ...
    public String getAPIKey(String module) {
        ...
        String todayStr = SDF_YYYYMMDD_HHMMSS.format(new Date());
    ...
    private boolean isGenerateTimeValid(String generateTime, Date currentDate, int apiKeyAcceptableMins) {
        try {
            Date generateDateTime = SDF_YYYYMMDD_HHMMSS.parse(generateTime);
